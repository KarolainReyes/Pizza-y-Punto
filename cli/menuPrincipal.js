...
import RegistrarPedido from "../commands/reqistrarPedido.js";
...
async function subMenuPizzas(pizzaService, ingredientesService) {
    const { opcionPizza } = await inquirer.prompt([
        {
            ...
            choices: [
                ...
                { name: " Editar Pizzas ", value: "2" },
                { name: " Eliminar Pizza ", value: "3" },
                { name: " Ver Pizzas ", value: "4" },
                { name: " Volver ", value: "5" }
            ]
        }
    ]);
    ...
    switch (opcionPizza) {
        case "1":
            ...
            break;
        case "2":
            console.log("Editar Pizza - por implementar");
            break;
        case "3":
            console.log("Eliminar Pizza - por implementar");
            break;
        case "4":
            console.log("Eliminar Pizza - por implementar");
            break;
...
async function subMenuPedidos(pedidoService, pizzaService, clienteService, repartidorService) {
    ...
    switch (opcionPedido) {
        case "1":
            ...
            break;
        case "2":
            console.log("Eliminar Pedido - por implementar");
            break;
        case "3":
            console.log("Eliminar Pizza - por implementar");
            break;
...
async function subMenuClientes(clienteService) {
    ...
    switch (opcionCliente) {
        case "1":
            ...
            break;
        case "2":
            console.log("Eliminar Cliente - por implementar");
            break;
        case "3":
            console.log("Eliminar Pizza - por implementar");
            break;
...
async function subMenuRepartidores(repartidorService) {
    ...
    switch (opcionRepartidor) {
        case "1":
            ...
            break;
        case "2":
            console.log("Eliminar Repartidor - por implementar");
            break;
        case "3":
           console.log("Eliminar Pizza - por implementar");
            break;
...
async function subMenuAlmacen(ingredientesService) {
    const { opcionAlmacen } = await inquirer.prompt([
        {
            ...
            choices: [
                ...
                { name: " Editar Ingrediente ", value: "3" },
    ...
    switch (opcionAlmacen) {
        case "1":
            console.log("Eliminar Pizza - por implementar");
        case "2":
            console.log("Eliminar Ingrediente - por implementar");
            break;
        case "3":
            console.log("Editar Ingrediente - por implementar");
            break;
        case "4":
            console.log("Eliminar Pizza - por implementar");
            break;
